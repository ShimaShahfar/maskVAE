...
class BaseOptions():
    ...
    def initialize(self):    
        ...
        # for setting inputs
        self.parser.add_argument('--dataroot', type=str, default='../../maskgan/data/cityscapes/', help='path to dataset') 
        self.parser.add_argument('--vae_path', type=str, default='checkpoint_vae/000070.pt', help='path to vae checkpoints') 
