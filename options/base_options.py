...
class BaseOptions():
    ...
    def initialize(self):    
        ...
        self.parser.add_argument('--label_nc', type=int, default=34, help='# of input label channels')
        self.parser.add_argument('--input_nc', type=int, default=1, help='# of input image channels')
        self.parser.add_argument('--output_nc', type=int, default=3, help='# of output image channels')
        
        # for setting inputs
        self.parser.add_argument('--dataroot', type=str, default='../data/cityscapes/', help='path to dataset') 
        self.parser.add_argument('--vae_path', type=str, default='../../CelebAMask-HQ/MaskGAN_demo/checkpoint_vae/000070.pt', help='path to vae checkpoints') 
